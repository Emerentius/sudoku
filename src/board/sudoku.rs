...
///
/// For use with functions like [`Sudoku::generate_unique_with_symmetry`].
#[non_exhaustive]
...
impl Sudoku {
    ...
    pub fn generate_unique() -> Self {
        Sudoku::generate_unique_with_symmetry(Symmetry::HalfRotation)
    }
    ...
    /// whilst also upholding the symmetry.
    /// Most puzzles generated by this are easy.
    pub fn generate_unique_with_symmetry(symmetry: Symmetry) -> Self {
        Sudoku::generate_unique_with_symmetry_from(Sudoku::generate_filled(), symmetry)
    }
    ...
    ///
    /// Equivalent to `Sudoku::generate_unique_with_symmetry_from(sudoku, Symmetry::None)`
    pub fn generate_unique_from(sudoku: Sudoku) -> Self {
        Sudoku::generate_unique_with_symmetry_from(sudoku, Symmetry::None)
    }
    ...
    pub fn generate_unique_with_symmetry_from(mut sudoku: Sudoku, symmetry: Symmetry) -> Self {
