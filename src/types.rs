...
impl Entry {
	...
	#[inline] pub(crate) fn mask(self) -> Mask<Digit> { Mask::from_num(self.num()) }
}
...
#[derive(Clone, Copy, PartialEq, Eq, Debug)] pub(crate) struct Position(pub u8);
