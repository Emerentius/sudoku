...
mod test {
    ...
    #[test]
    fn xy_wing() {
        let sudoku = Sudoku::from_str_line("9..24.....5.69.231.2..5..9..9.7..32...29356.7.7...29...69.2..7351..79.622.7.86..9")
            .unwrap();
        ...
        if let crate::strategy::Deduction::Wing { hinge, pincers, conflicts, .. } = deductions.get(0).unwrap() {
