...
impl Sudoku {
    ...
    /// Generate a random, uniquely solvable sudoku with 90° rotational symmetry.
    ///
    ...
    pub fn generate_unique() -> Self {
        Sudoku::generate_unique_with_symmetry(Symmetry::QuarterRotation)
    }
    ...
    pub fn generate_unique_with_symmetry(symmetry: Symmetry) -> Self {
        Sudoku::generate_unique_from(Sudoku::generate_filled(), symmetry)
    }
    ...
    pub fn generate_unique_from(mut sudoku: Sudoku, symmetry: Symmetry) -> Self {
